...
import {
  ...
  update,
  user_derived
} from "./chunk-RGQH5T7Q.js";
import "./chunk-L3IDHH4W.js";
import "./chunk-JDHMBBRX.js";
...
var root_2 = add_locations(from_svg(`<svg><!></svg>`), Icon[FILENAME], [[105, 2]]);
var root_3 = add_locations(from_html(`<span></span>`), Icon[FILENAME], [[109, 2]]);
function Icon($$anchor, $$props) {
  ...
  let counter2 = tag(state(0), "counter");
  let isMounted = tag(user_derived(() => !!$$props.ssr || get(mounted)), "isMounted");
  let iconData = tag(
    user_derived(() => {
      get(counter2);
      return checkIconState($$props.icon, iconState, get(isMounted), loaded, $$props.onload);
    }),
    "iconData"
  );
  let data = tag(
    user_derived(() => {
      ...
      if (generatedData && get(iconData).classes) {
