...
<main>
    ...
    <div class={`${navmenu ? 'right-0' : '-right-65'} fixed w-65 h-screen bg-[#0d1b2a] z-10 transition-all duration-500 flex flex-col items-center overflow-y-auto justify-start`}>
        <div class="w-full flex flex-col items-center justify-around min-h-[400px]">
            ...
            <Navbutton site="/SpaceCake" name="SpaceCake" background="/SpaceCake.png" onClick={clickButton}/>
            <Navbutton site="/Jammaze" name="Jamaze" background="/JAMMAZE.png" onClick={clickButton}/>
            <Navbutton site="/MM" name="Matrix<br>Memories" background="/cave.png" onClick={clickButton}/>
            <Navbutton site="/KIB" name="KIB.EXE" background="/KIB.png" onClick={clickButton}/>
        </div>
        ...
        <div class="w-full flex flex-col items-center justify-around min-h-[270px] mt-10 mb-[100px]">
            ...
            <Navbutton name="Ricky Games" background="/ricky2.png" site="/RickyGames" onClick={clickButton}/>
        </div>
    </div>
    {#if navmenu}
    <!-- svelte-ignore a11y_click_events_have_key_events -->
