...
<div class="bg-[#1b263b] flex flex-col items-center">
    ...
    <div class="w-full h-screen flex justify-center items-center -mt-[80px]">
        <h1 class="title text-[120px] text-[#e0e1dd]">SpaceCake</h1>
    </div>
    <div class="mt-30"></div>
    <!-- svelte-ignore a11y_missing_attribute -->
     <div class="my-10">
        <iframe frameborder="0" src="https://itch.io/embed/3260785?linkback=true&amp;border_width=0&amp;bg_color=0d1b2a&amp;fg_color=e0e1dd&amp;link_color=415a77&amp;border_color=415a77" width="550" height="165"><a href="https://threels.itch.io/spacecake">SpaceCake by threels</a></iframe>
    </div>
    <Wave text="A propos de<br> SpaceCake" size={80} speed={0.1}></Wave>
    <p class="mt-15 w-265 text-center"><strong>Qu'est-ce que SpaceCake ?</strong></p>
