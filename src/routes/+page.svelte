...
<div class="overflow-hidden bg-[#1b263b] w-full">
    ...
    <div class="flex flex-col justify-center items-center mt-30">
        ...
        <PresR site="/SpaceCake" className="presR-1" background="/SpaceCake.png" description="SpaceCake est un jeu réalisé pendant une JAM sur le thèmes de l'espace. Nous avons donc décidé de créer un jeu ou l'astronaute doit monter plus vite que la caméra qui monte de plus en plus vite, tout en esquivant les planètes qui barrent son chemin et les trous noirs qui cherche à l'absorber."/>   
        <PresL site="/Jammaze" className="presL-1" background="/JAMMAZE.png" description="Jamaze est aussi un jeu réalisé lors d'une JAM. Cette fois-ci, nous avons décidé d'explorer la 3D en créant un petit jeu d'horreur. Un univers sombre, des cinématiques et un peu de lore vous y attendent."/>
        <PresR site="MM" className="presR-2" background="/cave.png" description="Matrix Memories est le vrai premier jeu que nous aimerions sortir. Il mélange des classiques tel que stardew valley, undertale, one shot et apporte sa pierre à l'édifice avec son histoire touchante et profonde."/>   
        <PresL site="KIB" className="presL-2" background="/KIB.png" description="KIB.EXE est le jeu le plus ambitieux que nous ayons entrepris. Il pourrait évoquer des titres comme l’excellent Inscryption ou même Balatro, mais il reste unique par son histoire et son gameplay soigneusement travaillé."/>
    </div>
    <div class="flex flex-col justify-center items-center mt-30">
